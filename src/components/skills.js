...
export default function Skills() {
  return (
    <div className="py-5 md:py-20" id="skills">
      <h1 className="text-4xl lg:text-6xl font-bold pt-10 text-primary dark:text-dark-primary text-center">
        Skills
      </h1>
      <ul className="flex flex-col items-center md:items-baseline md:flex-row justify-center mt-10 gap-20">
        <li>
          <ul className="flex flex-col items-start">
            <li className="text-xl md:text-3xl text-secondary dark:text-dark-secondary">
              Design
            </li>
            <li className="flex items-center md:text-xl mt-5 text-primary dark:text-dark-secondary">
              <FigmaLogoIcon className="mr-3" />
              Figma
            </li>
            <li className="flex items-center mt-3 md:text-xl text-secondary dark:text-dark-primary">
              <svg
                className="mr-2"
                stroke="currentColor"
                fill="currentColor"
        ...
        <li>
          <ul className="flex flex-col items-start">
            ...
            <li className="flex items-center md:text-xl mt-5 text-primary dark:text-dark-primary">
              <FontAwesomeIcon icon={faReact} className="mr-3" />
              React
            </li>
            <li className="flex items-center md:text-xl mt-3 text-secondary dark:text-dark-secondary">
              <FontAwesomeIcon icon={faReact} className="mr-3" />
              Next
            </li>
          </ul>
        ...
        <li>
          <ul className="flex flex-col items-start">
            ...
            <li className="flex items-center mt-3 md:text-xl text-secondary dark:text-dark-secondary">
              <svg
                className="mr-2"
                stroke="currentColor"
                fill="currentColor"
        ...
        <li>
          <ul className="flex flex-col items-start">
            ...
            <li className="flex items-center md:text-xl mt-5 text-secondary dark:text-dark-secondary">
              <CommitIcon className="mr-3" />
              git
            </li>
            <li className="flex items-center mt-3 md:text-xl text-primary dark:text-dark-primary">
              <GitHubLogoIcon className="mr-3" />
              github
            </li>
            <li className="flex items-center mt-3 md:text-xl text-secondary dark:text-dark-secondary">
              <VercelLogoIcon className="mr-3" />
              versel
            </li>
          </ul>
        </li>
